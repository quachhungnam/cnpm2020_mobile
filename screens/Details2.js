...
export default class Details2Screen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            images: [
            ...
            <ScrollView style={{backgroundColor: '#eee'}} showsVerticalScrollIndicator={true}>
                ...
                <View style={{flex: 100, flexDirection: 'row'}}>
                    <TouchableHighlight style={{flex: 50, marginBottom: 10, padding: 10, borderRadius: 20, backgroundColor: 'coral'}}
                        ...
                        <Text style={{textAlign: 'center'}}>Sửa bài đăng</Text>
                    </TouchableHighlight>
                    <TouchableHighlight style={{flex: 50, marginBottom: 10, marginLeft: 10, padding: 10, borderRadius: 20, backgroundColor: 'red'}}
                    onPress={() => {
                        
                    }}
                    >
                        <Text style={{textAlign: 'center', color: 'white'}}>Xóa bài đăng</Text>
                    </TouchableHighlight>
                </View>
