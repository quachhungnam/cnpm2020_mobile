...
export default function EditPasswordAccountScreen(props) {
      ...
      if (new_pass.password1 == new_pass.password2) {
        ...
        check_account_password(old_user, account_token).then(rs => {
          if (rs.success == false) {
            ...
            const new_user = {
              _id: account_infor._id,
              password: new_pass.password1,
            };
  ...
  return (
    <ScrollView
      ...
      <Text style={styles.txt_pass}>Mật khẩu cũ</Text>
      <TextInput
      ...
      />
      <Text style={styles.txt_pass}>Mật khẩu mới</Text>
      <TextInput
        style={styles.input_pass}
        returnKeyType="next"
        secureTextEntry
      ...
      />
      <Text style={styles.txt_pass}>Xác nhận mật khẩu mới</Text>
      <TextInput
        style={styles.input_pass}
        returnKeyType="go"
        secureTextEntry
